<%@ Page validateRequest="false" Title="Lake Map Editor" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="LakeMap.aspx.cs" 
        Inherits="FishTracker.Editor.LakeMap" %>
...
<table style="width: 889px">
    ...
    <tr>
        <td class="auto-style41">Source</td>
        <td class="auto-style43">                
            <asp:TextBox ID="txSource" runat="server" style="margin-left: 35px" Width="280px"></asp:TextBox>
        </td>
        <td class="auto-style44"></td>
        <td class="auto-style51">
            <asp:Label ID="imageType" runat="server" Text="Image Type:"></asp:Label>
        </td>
        <td class="auto-style1"><table><tr><td>
            <asp:DropDownList ID="ddlFlow" runat="server" Height="16px">
                <asp:ListItem Value="4">Link</asp:ListItem>
                <asp:ListItem Value="1">Map</asp:ListItem>
                <asp:ListItem Value="2">Document</asp:ListItem>
                <asp:ListItem Value="8">Image</asp:ListItem>
            </asp:DropDownList></td>
            <td><asp:TextBox ID="txDate" runat="server" Width="205px" CssClass="auto-style53" TextMode="Date" Height="23px"></asp:TextBox>
           </td></tr></table>
        </td>
    </tr> 
    ...
    <tr>
        ...
        <td class="auto-style43"><asp:TextBox ID="txLat" runat="server" style="margin-left: 35px" Width="280px"></asp:TextBox></td>
        <td class="auto-style44"></td>
        <td class="auto-style51">Author:</td>
        <td class="auto-style1">
            <asp:TextBox ID="txAuthor" runat="server" Width="280px" CssClass="auto-style53"></asp:TextBox></td>
    </tr> 
    <tr>
        <td class="auto-style41">Longitude:</td>
        <td class="auto-style43"><asp:TextBox ID="txLon" runat="server" style="margin-left: 35px" Width="280px"></asp:TextBox></td>
        <td class="auto-style44"></td>
        <td class="auto-style51">Link:</td>
        <td class="auto-style48"><asp:TextBox ID="txLink" runat="server" Width="280px" CssClass="auto-style53" TextMode="Url"></asp:TextBox></td>
    </tr> 
    <tr style="background-color: #b6b7bc"><td class="auto-style42"></td><td class="auto-style40"></td><td class="auto-style45"></td><td class="auto-style47"></td><td></td></tr> 
    <%=hiddenGrid.Value%>
    <tr style="background-color: #b6b7bc"><td class="auto-style42"></td><td class="auto-style40"></td><td class="auto-style45"></td><td class="auto-style47"></td><td></td></tr> 
    <tr><td class="auto-style49">
        ...
        <td class="auto-style40">
            ...
            <asp:Button ID="ButtonDelHidden" runat="server" Text="X" OnClick="ButtonDelMap_Click" Height="16px" Width="16px" />
        </td>
        <td></td><td class="auto-style52">
                <asp:Button ID="ButtonSubmit" runat="server" Text="Upload" Width="108px" OnClick="ButtonSubmit_Click" />
            </td><td>
                <table>
                    <tr>
